...
(define-public (register-generator (generator-type uint) (capacity uint) (location (string-ascii 100)))
...
;; Update generator production
(define-public (update-production (generator-id uint) (energy-generated uint))
  (match (map-get? generators { generator-id: generator-id })
    generator-data
    (if (is-eq (get owner generator-data) tx-sender)
      (match (map-get? generator-stats { generator-id: generator-id })
        ...
        (begin
          (map-set generator-stats
            { generator-id: generator-id }
            {
              total-generated: (+ (get total-generated stats-data) energy-generated),
              last-update: block-height,
              efficiency-rating: (get efficiency-rating stats-data)
            }
          )
          (ok true)
        )
